...
CHECKS = [
    ...
    ("Validate Process Step token migration", ["tools/check_process_step_token_migration.py"]),
    ...
    ("Validate verified deploy drift watchdog", ["tools/check_verified_deploy_drift_workflow.py"]),
    ...
    ("Validate base live health workflow", ["tools/check_live_health_workflow.py"]),
