...
REPLACEMENTS = (
    ...
    (
        ...
        "Заявка сохранена. Текст скопирован как памятка; после связи Иван подскажет, как передать фотографии пола.",
    ),
    (
        "Автоматически отправить заявку не удалось. Текст скопирован: отправьте его Ивану вместе с фото или позвоните.",
        "Сохранить заявку автоматически не удалось. Текст скопирован как памятка. Позвоните Ивану; способ передачи фото согласуйте во время разговора.",
    ),
    (
        "Заявка отправлена Ивану. Скопируйте готовый текст ниже и приложите к нему фотографии пола.",
        "Заявка сохранена. Скопируйте готовый текст ниже как памятку; после связи Иван подскажет, как передать фотографии пола.",
    ),
    (
...
def self_test() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="parket36-lead-copy-") as temp:
        ...
        script.write_text(
            ...
            "const classifier = text.startsWith('Автоматически отправить заявку не удалось');\n"
        ...
        required = (
            ...
            "Сохранить заявку автоматически не удалось",
            "text.startsWith('Сохранить заявку автоматически не удалось')",
