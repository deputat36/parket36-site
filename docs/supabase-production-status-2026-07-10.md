...
> Исторический снимок от 10 июля 2026 года. Более свежая read-only проверка безопасности объектов Паркет36 выполнена 3 августа 2026 года и зафиксирована в `docs/supabase-production-security-status-2026-08-03.md`. Для текущих решений сначала использовать августовский документ, а этот файл — только для истории первоначального production drift и retention migration.
