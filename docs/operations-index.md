...
- `docs/project-next-actions.md` — ближайшие действия по открытым задачам.
- `docs/full-audit-autonomous-roadmap-2026-07-10.md` — всесторонний аудит и автономная дорожная карта развития.
...
- `docs/live-request-copy-monitoring.md` — проверка главной и `/zayavka/` на редакторские заглушки и безусловные обещания доставки заявки.
...
- `docs/search-launch-readiness.md` — автоматический post-deploy отчёт по live-домену, robots/sitemap, ключу IndexNow и готовности Метрики с одним status-комментарием в issue #308.
...
- `docs/request-readiness.md` — неблокирующий индикатор полноты подробной заявки и обратного звонка без передачи значений полей в аналитику.
- `docs/form-fail-closed.md` — защита форм при отключённом или частично загрузившемся JavaScript без ложной отправки и потери введённых полей.
...
- `docs/first-touch-attribution.md` — сохранение первой кампании и посадочной страницы при навигации до заявки.
- `docs/content-inventory.md` — автоматически поддерживаемый реестр публичных страниц, метаданных, объёма, внутренних ссылок и конверсионных элементов.
...
- `docs/full-audit-autonomous-roadmap-2026-07-10.md` — полный аудит бизнеса, SEO, конверсии, безопасности, производительности и автономности.
